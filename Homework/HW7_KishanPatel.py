...
print("(Bells) - 'a' 'an' Frequency:", litCricFriend(["a", "an"], theBells))
print("(CantoXII) - 'a' 'an' Frequency:", litCricFriend(["a", "an"], cantoXII))
print("(Bells) - 'the' Frequency:", litCricFriend(["the"], theBells))
print("(CantoXII) - 'the' Frequency:", litCricFriend(["the"], cantoXII))
...
'''
Yes, from the output it shows that Poe and Neruda use "a", "an", and "the" differently because the ratio shows that 
there is a large difference between each poem.
'''
